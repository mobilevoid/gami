...
CACHE_HITS = Counter(
    "gami_cache_hits_total",
    "Cache hit count",
    ["cache_type"],
)

CACHE_MISSES = Counter(
    "gami_cache_misses_total",
    "Cache miss count",
    ["cache_type"],
)
...
EMBEDDING_LATENCY = Histogram(
    "gami_embedding_latency_seconds",
